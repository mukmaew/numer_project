    ...
    render() {
        return (
            <Content className="site-layout" style={{ padding: 24, background: '#CCFFFF', minHeight: 1200}}>
                ...
                <h2 style={{ textAlign: 'margin-right : 150' }}>Conjugate Gradient Iteration Method</h2>
                <div >
                    <div >
                        <Card
                            bordered={true}
                            style={{  background: '#CCFFFF', borderRadius:"15px", color: "#FFFFFFFF" }}
                            onChange={this.handleChange}
                        >
                            {this.state.showDimentionForm &&
                                <div>
                                    <h2>Row</h2><Input size="large" name="row" style={{ width: 350 }}></Input>
                                    <h2>Column</h2><Input size="large" name="column" style={{ width: 350 }}></Input><br></br>
                                    <br></br>
